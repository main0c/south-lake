...
protocol SourceViewer: class, Databasable {
    ...
    /// A tab passes a data source to the viewer. It may be nil. The viewer may
    /// make any changes it likes to the source, including metadata changes.
    /// Viewers should use the NSData interface for source contents
