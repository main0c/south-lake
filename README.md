...
More: improved markdown (images), interdocument linking, table of contents, calendar view, model and ui tests, templates (plugins), autocompletion (plugins), text snippets (Sublime), collaboration...
